        ...
        <div className="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
          ...
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="flex items-center border-b border-gray-300 py-2 transition focus-within:border-blue-900">
              ...
              <input
                type="email"
                placeholder="daniel.ahmadi@gmail.com"
                className="w-full bg-transparent font-medium text-blue-950 outline-none placeholder:text-gray-500"
                defaultValue="daniel.ahmadi@gmail.com"
              />
              <svg className="ml-2 h-5 w-5 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
              </svg>
            ...
            <div className="mt-2 space-y-1">
              <div className="flex items-center text-xs text-gray-400">
                <div className="mr-2 h-1.5 w-1.5 rounded-full bg-gray-300"></div>
                Least 8 characters
              </div>
            ...
            <div className="pt-4">
              <button className="flex w-48 items-center justify-between rounded-full bg-blue-900 px-8 py-3 font-semibold text-white shadow-lg shadow-blue-900/30 transition hover:bg-blue-800">
                Sign Up
        ...
        <div className="relative z-10 flex w-full max-w-lg flex-col gap-8 px-8">
          <div className="flex items-end gap-6">
            <div className="w-64 -rotate-2 transform rounded-2xl bg-white p-6 shadow-xl transition duration-300 hover:rotate-0">
              <h3 className="mb-1 text-sm font-bold text-orange-500">Active Students</h3>
              <p className="mb-6 text-3xl font-extrabold text-blue-950">17,618</p>
          ...
          <div className="relative overflow-hidden rounded-2xl bg-white p-8 shadow-xl">
            ...
            <div className="relative z-10 ml-20">
              ...
              <h3 className="mb-2 text-xl font-bold text-blue-950">Smart Tracking, Seamless Learning</h3>
              <p className="text-sm leading-relaxed text-gray-400">
                Your academic data is secured and streamlined. Experience the modern campus with EduTrack&apos;s integrated toolkit.
              </p>
            </div>
          </div>
        </div>
